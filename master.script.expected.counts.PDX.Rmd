...
write.table(markers, file = "/Users/paigehalas/Desktop/norm.brca.pdx.std.integrated.res025.RNA.markers.txt")
library(dplyr)
top10 <- markers %>% group_by(cluster) %>% top_n(n = 10, wt = avg_logFC)
DoHeatmap(UMAP.integrated.data, features = top10$gene, assay = "integrated") + NoLegend()
```
