...
```{r look.at.percent.mito,fig.height=4, fig.width=8}
...
##Try to rescale the data to account for differences in n_Feature and percent mit 

```{r re.scale.PCA.MAP.data.and.look.at.feature.plots,fig.height=4, fig.width=8}
DefaultAssay(integrated.data) <- "integrated"
