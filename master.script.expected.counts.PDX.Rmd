...
## Define cluster markers (RNA assay data slot--correct way)

```{r markers.need.to.be.in.RNA, eval=FALSE,echo=FALSE}
...
integrated.data.g<-ScaleData(integrated.data,features = all.genes,assay = "RNA")
#save(integrated.data.g, file = "/Users/paigehalas/Desktop/integrated.data.all.genes.scale.rda")
```

## Look at top 10 genes for RNA assay slot (correct way)
...
DoHeatmap(integrated.data.g, features = top10$gene, assay = "RNA") + NoLegend()
```
