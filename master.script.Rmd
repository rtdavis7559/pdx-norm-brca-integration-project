...
load("seurat-objects/norm.brca.integrated.epithelial.Rda")
```
```{r label.transfer.prep.objects, eval=FALSE, echo=FALSE}
...
```
```{r label.transfer.calculation, eval=FALSE, echo=FALSE}
...
```{r label.transfer.visualize.hci001, eval=TRUE, echo=FALSE, fig.height=4, fig.width=9}
load(file = "E:\\Scripts\\Seurat\\Seurat3_Objects\\hci001.counts.label.transfer.Seurat3.object.Rda")
...
pheatmap((as.matrix(hci001.prediction.heatmap)),
         ...
         cutree_cols = 3)
```
```{r label.transfer.visualize.hci002, eval=TRUE, echo=FALSE, fig.height=4, fig.width=9}
load(file = "E:\\Scripts\\Seurat\\Seurat3_Objects\\hci002.counts.label.transfer.Seurat3.object.Rda")
...
load(file = "E:\\Scripts\\Seurat\\Seurat3_Objects\\hci010.counts.label.transfer.Seurat3.object.Rda")
...
```{r calculate.module.scores.markers, echo=FALSE, eval=TRUE}
...
normal.basal.genes<-list(norm.basal=as.character(normal.basal.markers$gene))
normal.luminal1.markers<-subset(norm.brca.epithelial.coarse.ident.markers, cluster=="NORMAL.Luminal_1")
normal.luminal1.genes<-list(norm.basal=normal.luminal1.markers$gene)
normal.luminal2.markers<-subset(norm.brca.epithelial.coarse.ident.markers, cluster=="NORMAL.Luminal_2")
normal.luminal2.genes<-list(norm.basal=normal.luminal2.markers$gene)
brca.basal.markers<-subset(norm.brca.epithelial.coarse.ident.markers, cluster=="BRCA.Basal")
brca.basal.genes<-list(norm.basal=brca.basal.markers$gene)
brca.luminal1.markers<-subset(norm.brca.epithelial.coarse.ident.markers, cluster=="BRCA.Luminal_1")
brca.luminal1.genes<-list(norm.basal=brca.luminal1.markers$gene)
brca.luminal2.markers<-subset(norm.brca.epithelial.coarse.ident.markers, cluster=="BRCA.Luminal_2")
brca.luminal2.genes<-list(norm.basal=brca.luminal2.markers$gene)

DefaultAssay(hci001.query)<-"RNA"
hci001.query<-AddModuleScore(hci001.query, features = normal.basal.genes, name = "Normal_Basal_Score")
hci001.query<-AddModuleScore(hci001.query, features = normal.luminal1.genes, name = "Normal_Luminal_1_Score")
hci001.query<-AddModuleScore(hci001.query, features = normal.luminal2.genes, name = "Normal_Luminal_2_Score")
hci001.query<-AddModuleScore(hci001.query, features = brca.basal.genes, name = "BRCA_Basal_Score")
hci001.query<-AddModuleScore(hci001.query, features = brca.luminal1.genes, name = "BRCA_Luminal_1_Score")
hci001.query<-AddModuleScore(hci001.query, features = brca.luminal2.genes, name = "BRCA_Luminal_2_Score")

DefaultAssay(hci002.query)<-"RNA"
hci002.query<-AddModuleScore(hci002.query, features = normal.basal.genes, name = "Normal_Basal_Score")
hci002.query<-AddModuleScore(hci002.query, features = normal.luminal1.genes, name = "Normal_Luminal_1_Score")
hci002.query<-AddModuleScore(hci002.query, features = normal.luminal2.genes, name = "Normal_Luminal_2_Score")
hci002.query<-AddModuleScore(hci002.query, features = brca.basal.genes, name = "BRCA_Basal_Score")
hci002.query<-AddModuleScore(hci002.query, features = brca.luminal1.genes, name = "BRCA_Luminal_1_Score")
hci002.query<-AddModuleScore(hci002.query, features = brca.luminal2.genes, name = "BRCA_Luminal_2_Score")

DefaultAssay(hci010.query)<-"RNA"
hci010.query<-AddModuleScore(hci010.query, features = normal.basal.genes, name = "Normal_Basal_Score")
hci010.query<-AddModuleScore(hci010.query, features = normal.luminal1.genes, name = "Normal_Luminal_1_Score")
hci010.query<-AddModuleScore(hci010.query, features = normal.luminal2.genes, name = "Normal_Luminal_2_Score")
hci010.query<-AddModuleScore(hci010.query, features = brca.basal.genes, name = "BRCA_Basal_Score")
hci010.query<-AddModuleScore(hci010.query, features = brca.luminal1.genes, name = "BRCA_Luminal_1_Score")
hci010.query<-AddModuleScore(hci010.query, features = brca.luminal2.genes, name = "BRCA_Luminal_2_Score")

quantile(hci001.query$prediction.score.BRCA.Luminal_1)
hci001.query@meta.data <- mutate(hci001.query@meta.data, Normal.Basal.Prediction.Quantiles = ifelse(prediction.score.NORMAL.Basal <= 0.11121587, "4. Lowest (<= 0.11121587)",
                                     ifelse(prediction.score.NORMAL.Basal <= 0.14351266, "3. Low (<= 0.14351266)",
                                            ifelse(prediction.score.NORMAL.Basal <= 0.16849673, "2. High (<= 0.16849673)", "1. Highest (> 0.16849673)"))))
hci001.query@meta.data <- mutate(hci001.query@meta.data, Normal.Luminal1.Prediction.Quantiles = ifelse(prediction.score.NORMAL.Luminal_1 <= 0.5397483, "4. Lowest (<= 0.5397483)",
                                     ifelse(prediction.score.NORMAL.Luminal_1 <= 0.5837266, "3. Low (<= 0.5837266)",
                                            ifelse(prediction.score.NORMAL.Luminal_1 <= 0.6197146, "2. High (<= 0.6197146)", "1. Highest (> 0.6197146)"))))
hci001.query@meta.data <- mutate(hci001.query@meta.data, Normal.Luminal2.Prediction.Quantiles = ifelse(prediction.score.NORMAL.Luminal_2 <= 0.000000000, "4. Lowest (<= 0.000000000)",
                                     ifelse(prediction.score.NORMAL.Luminal_2 <= 0.005199667, "3. Low (<= 0.005199667)",
                                            ifelse(prediction.score.NORMAL.Luminal_2 <= 0.019263320, "2. High (<= 0.019263320)", "1. Highest (> 0.019263320)"))))
hci001.query@meta.data <- mutate(hci001.query@meta.data, BRCA.Basal.Prediction.Quantiles = "NA")
hci001.query@meta.data <- mutate(hci001.query@meta.data, BRCA.Luminal1.Prediction.Quantiles = ifelse(prediction.score.BRCA.Luminal_1 <= 0.15272844, "4. Lowest (<= 0.15272844)",
                                     ifelse(prediction.score.BRCA.Luminal_1 <= 0.21370578, "3. Low (<= 0.21370578)",
                                            ifelse(prediction.score.BRCA.Luminal_1 <= 0.25355237, "2. High (<= 0.25355237)", "1. Highest (> 0.25355237)"))))
rownames(hci001.query@meta.data)<-rownames(p01.counts@meta.data)
VlnPlot(hci001.query, "BRCA_Luminal_1_Score1", group.by = "Normal.Luminal1.Prediction.Quantiles", split.by = "tissue")
```

## Save Seurat Objects (Last Saved: 04/28/20)
...
#save(hci001.query, file = "E:\\Scripts\\Seurat\\Seurat3_Objects\\hci001.counts.label.transfer.Seurat3.object.Rda")
#save(hci002.query, file = "E:\\Scripts\\Seurat\\Seurat3_Objects\\hci002.counts.label.transfer.Seurat3.object.Rda")
#save(hci010.query, file = "E:\\Scripts\\Seurat\\Seurat3_Objects\\hci010.counts.label.transfer.Seurat3.object.Rda")
```