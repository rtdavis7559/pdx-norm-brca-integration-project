...
pheatmap((as.matrix(hci010.prediction.heatmap)),
         ...
         cutree_cols = 5)
```
```{r label.transfer.epithelial.marker.genes, echo=T, eval=F}
DefaultAssay(norm.brca.integrated.epithelial)<-"RNA"
Idents(norm.brca.integrated.epithelial)<-"Coarse.Ident"
norm.brca.epithelial.markers <- FindAllMarkers(norm.brca.integrated.epithelial, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
```
