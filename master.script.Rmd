...
```{r label.transfer.prep, eval=FALSE}
#HCI001
load("seurat-objects/hci001.expected.counts.trimmed.seurat3.object.Rda")
#HCI002
load("seurat-objects/hci002.expected.counts.trimmed.seurat3.object.Rda")
...
table(hci001.query$predicted.id)
table(hci002.query$predicted.id)
table(hci010.query$predicted.id)

plot(as.numeric(hci001.query$prediction.score.Luminal_1)
