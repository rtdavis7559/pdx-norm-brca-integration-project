...
```{r load.objects}
#HCI001
load("seurat-objects/hci001.counts.trimmed.seurat3.object.Rda")
#HCI002
load("seurat-objects/hci002.counts.trimmed.seurat3.object.Rda")
#HCI010
load("seurat-objects/hci010.counts.trimmed.seurat3.object.Rda")
#Norm/BRCA
...
My PDX data has a slot called RNA, which was my TPM values, while the expected_counts slot contains the count data. In the Norm/BRCA dataset their RNA slot is counts data. I need to transfer the values from @assays$expected.counts to @assays$RNA for my PDX data.
