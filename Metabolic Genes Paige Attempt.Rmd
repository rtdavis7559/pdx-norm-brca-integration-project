...
```{r import.list.of.metabolic.genes.and.convert.to.characters, eval = FALSE}
...
```{r configure.excel.to.make.lists.add.lists.to.dictionary, eval = FALSE}
...
```{r import.Norm.BRCA.data, eval = FALSE, echo = FALSE}
...
```{r add.module.scores, eval = FALSE}
...
```{r make.a.new.matrix.where.you.are.looking.at.cell.type.status.pathways.and.score, eval = FALSE}
...
```{r plot.cell.types.with.glycolysis.and.oxphos, fig.height=4, fig.width=8}
