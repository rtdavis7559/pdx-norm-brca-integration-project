...
```{r import.list.of.metabolic.genes.and.convert.to.characters}
...
```{r configure.excel.to.make.lists.add.lists.to.dictionary}
...
```{r make.a.new.matrix.where.you.are.looking.at.cell.type.status.pathways.and.score}
...
```{r plotting.pathway.score, fig.height=8, fig.width=12}
...
```{r plotting.based.on.color.and.cell.type, fig.height=8, fig.width=12 }
...
``` {r plotting.only.boxplots.of.pathways.of.interest, fig.height=8, fig.width=12}
...
```{r plot.cell.types.with.glycolysis.and.oxphos, fig.height=8, fig.width=12}
